#
# Sphinx config file for syslog2 project.
#
...
# This env var is evaluated in the syslog2 package and causes the methods
...
version = get_version(os.path.join('..', 'syslog2', '_version.py'))
...
latex_documents = [
    (master_doc, 'syslog2.tex', _short_description, author, 'manual'),
]
...
man_pages = [
    (master_doc, 'syslog2', _short_description, [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'syslog2', _short_description,
     author, 'syslog2', _short_description,
     'Miscellaneous'),
]
        ...
        try:
            ...
            if 'methods' in self.options:
                ...
                for method in methods:
                    ...
                    if def_module_name.startswith('syslog2'):
